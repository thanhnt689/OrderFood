...
import com.ntt.orderfood.MainActivity
import com.ntt.orderfood.R
import com.ntt.orderfood.databinding.FragmentMyProfileBinding
                ...
                imageFolder.putFile(imageUri)
                    .addOnSuccessListener {
                        ...
                        imageFolder.downloadUrl.addOnSuccessListener {
                            ...
                            val prefO = dataBase.getReference("User")
                            prefO.child(user.phone).setValue(user)
